...
">
    <q-header elevated>
      <q-toolbar>
        ...
        <img class="q-ml-sm" style="height:50px; width: 50px" src="../assets/logo.png"/>
        <q-toolbar-title>
      ...
      <q-img class="absolute-top" src="../assets/material.png" style="height: 150px">
        <div class="absolute-bottom bg-transparent">
          <q-avatar size="56px" class="q-mb-sm">
            <img :src="storeUser.avatar == null || storeUser.avatar == '' ? env+'/img/avatar.0ebc89a2.jpg' :storeUser.avatar ">
          </q-avatar>
